...
%EA%B4%91%EC%A3%BC%EC%9D%B8%EA%B3%B5%EC%A7%80%EB%8A%A5%EC%82%AC%EA%B4\
%80%ED%95%99%EA%B5%90&sm=tab_pge&sort=0&photo=0&field=0&reporter_article=\
    &pd=0&ds=&de=&docid=&nso=so:r,p:all,a:all&mynews=0&cluster_rank=69&start='
start_num = 1
...
news_section = soup.select(
    ...
    div[id=main_pack] > div.news.mynews.section._prs_nws > ul[class=type01] > li')
